...
@Deprecated("Use this.let(::listOfNotNull) instead", ReplaceWith("this.let(::listOfNotNull)"))
fun <T: Any> T?.singletonOrEmptyList(): List<T> = if (this != null) Collections.singletonList(this) else Collections.emptyList()

@Deprecated("Use this.let(::listOf) instead", ReplaceWith("this.let(::listOf)"))
fun <T> T.singletonList(): List<T> = Collections.singletonList(this)

@Deprecated("Use this.let(::listOf) instead", ReplaceWith("this?.let(::setOf).orEmpty()"))
